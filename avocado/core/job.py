...
class Job(object):
    ...
    def __init__(self, args=None):
        ...
        self.product_build_number = getattr(self.args, 'product_build_number', '')
        self.new_patch_file = getattr(self.args, 'new_patch_file', '')
        self.jenkins_build_url = getattr(self.args, 'jenkins_build_url')
    ...
    def _log_avocado_version():
        job_log = _TEST_LOGGER
        job_log.info('CloudTest Version: %s', version.VERSION)
