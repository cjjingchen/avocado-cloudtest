...
class Run(CLICmd):
    ...
    def configure(self, parser):
        ...
        parser.add_argument('--product-build-number', action='store',
                            dest='product_build_number', default='',
                            help='Build number of the product be tested')

        parser.add_argument('--new-patch-file', action='store',
                            dest='new_patch_file', default='',
                            help='File that store the new patch list of the tested build')

        parser.add_argument('--jenkins-build-url', action='store',
                            dest='jenkins_build_url', default='',
                            help='Jenkins build number url to run this test')
