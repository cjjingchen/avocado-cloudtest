...
IdentityGroup = [
    cfg.StrOpt('admin_horizonurl',
               #simth modify
               #default='http://10.100.219.67:5000/v2.0/',
               default='https://10.100.219.67:5000/v2.0/',
...
ComputeGroup = [
    ...
    cfg.StrOpt('nodes',
               ...
               help="Dashboard Openstack url, v2"),
       #simth modify
    cfg.StrOpt('use_vcenter',
               default='test',
               help="mysql database url, v2"),

    cfg.StrOpt('auto_assign_floating_ip',
               default="1",
               help="floatingip"),
