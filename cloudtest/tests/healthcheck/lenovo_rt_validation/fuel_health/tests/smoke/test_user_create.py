...
class TestUserTenantRole(nmanager.SmokeChecksTest):
    ...
    def test_create_user(self):
        ...
        tenant = self.verify(100, self._create_tenant, 1,
        ...
        user = self.verify(100, self._create_user, 3, msg_s3,
        ...
        role = self.verify(100, self._create_role,
                           5, msg_s5,
                           'user role creation',
        ...
        auth = self.verify(100, self.identity_client.tokens.authenticate,
                           7, msg_s7,
                           'authentication',
                           username=user.name,
                           password=password,
        ...
        try:
            ...
            if self.config.compute.deployment_os == 'Ubuntu':
                ...
                #simth modify
                url = self.config.identity.admin_horizonurl
