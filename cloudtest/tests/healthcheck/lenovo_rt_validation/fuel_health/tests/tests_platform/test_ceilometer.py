...
class CeilometerApiPlatformTests(ceilometermanager.CeilometerBaseTest):
    ...
    def test_create_sample(self):
        ...
        self.verify(600, self.create_image_sample, 1, fail_msg, msg, image_id)
    ...
    def test_check_events_and_traits(self):
        ...
        kvm = self.config.compute.kvm
        image_name = 'cirros' if kvm else None
        instance = self.verify(600, self.create_server, 1, fail_msg, msg, name,
    ...
    def test_check_volume_events(self):
        ...
        kvm = self.config.compute.use_kvm
        image_name = 'cirros' if kvm else None
    ...
    def test_check_glance_notifications(self):
        ...
        msg = 'creating image'
        image = self.verify(20, self.glance_helper, 1, fail_msg, msg)
    ...
    def test_check_keystone_notifications(self):
        ...
        #simth commit it, since the response and the request do no match
