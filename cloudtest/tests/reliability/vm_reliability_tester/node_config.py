...
def update(package=None):
    if package:
        ...
        sudo(
            'apt-get -y --allow-unauthenticated --force-yes -o DPkg::Options::="--force-overwrite" -o DPkg::Options::="--force-confdef" update')
...
def upgrade(package=None):
    if package:
        cmd = str(
            'apt-get -y --allow-unauthenticated --force-yes -o DPkg::Options::="--force-overwrite" -o DPkg::Options::="--force-confdef" upgrade %s' % package)
        sudo(cmd)
    else:
        sudo(
...
def install(package):
    ...
    """
    cmd = str(
        'apt-get -y --allow-unauthenticated --force-yes -o DPkg::Options::="--force-overwrite" -o DPkg::Options::="--force-confdef" install %s' % package)
    sudo(cmd)
...
def pip_install(package):
    ...
    """
    cmd = str(
        'apt-get -y --allow-unauthenticated --force-yes -o DPkg::Options::="--force-overwrite" -o DPkg::Options::="--force-confdef" install python-pip')
    sudo(cmd)
